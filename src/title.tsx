  ...
  return (
    <>
      ...
      <div className="peopleS">
        <h1 className="center">Sebastien <a><div className='discord'><img/>Sebastien#2065</div></a></h1>
        <p className="txt">
          ...
          <a href='https://react.dev/'><img className='react' src="https://clouddevs.com/wp-content/uploads/2018/08/react-logo-transparent-380x380.png" alt="React" /></a> React, utilizing its powerful features to build dynamic and intuitive user interfaces. Currently, I am expanding my skill set by diving into <a href='https://tailwindcss.com/'><img className='react' src='https://th.bing.com/th/id/OIP.bZIWToswt8iVg8CwXzCgWAHaHa?pid=ImgDet&rs=1'/></a> Tailwind CSS, a utility-first framework that enables me to create efficient and visually appealing designs. Combining my passion for coding with a keen eye for detail, I strive to deliver elegant solutions that enhance the user experience. With a strong foundation in both front-end and back-end development, I am dedicated to crafting high-quality software that exceeds client expectations.
        </p>
      </div>
    </>
  );
